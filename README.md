...
```bash
# The Playbook works, but is not yet fully developed (WIP - Work in progress)
$ ansible-playbook -i /etc/ansible/proxmox/ansible/production/inventory.yml \
/etc/ansible/proxmox/ansible/site.yml --ask-become-pass
```
